...
from firstapp.models import Student, Course, StudentState, CourseDependency, Question, Feedback, Grade, ConfidenceRtoR, ConfidenceWtoW,Q1Q2RightWrong 
import datetime
...
sql = "SELECT * FROM firstapp_course;"
cursor.execute(sql)
...
object1 = Question_Concept(question=List[0].id,concept=List2[0].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[0].id,concept=List2[2].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[1].id,concept=List2[1].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[1].id,concept=List2[3].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[2].id,concept=List2[0].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[2].id,concept=List2[2].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[3].id,concept=List2[1].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[3].id,concept=List2[3].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[4].id,concept=List2[0].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[4].id,concept=List2[2].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[5].id,concept=List2[1].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[5].id,concept=List2[3].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[6].id,concept=List2[0].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[6].id,concept=List2[2].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[7].id,concept=List2[1].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[7].id,concept=List2[3].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[8].id,concept=List2[0].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[8].id,concept=List2[2].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[9].id,concept=List2[1].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[9].id,concept=List2[3].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[10].id,concept=List2[0].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[10].id,concept=List2[2].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[11].id,concept=List2[1].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[11].id,concept=List2[3].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[12].id,concept=List2[0].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[12].id,concept=List2[2].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[13].id,concept=List2[1].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[13].id,concept=List2[3].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[14].id,concept=List2[0].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[14].id,concept=List2[2].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[15].id,concept=List2[1].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[15].id,concept=List2[3].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[16].id,concept=List2[0].id,value=0.5)
object1.save()

object1 = Question_Concept(question=List[16].id,concept=List2[2].id,value=0.5)
object1.save()
